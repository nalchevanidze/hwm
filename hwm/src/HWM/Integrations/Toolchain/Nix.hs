...
generateOverlay :: Name -> BuildEnvironment -> [Text]
generateOverlay projectName benv =
  [ "haskellOverlay = final: prev: {",
    "      " <> renderNixName projectName <> " = prev.haskell.packages." <> formatNixGhc (buildGHC benv) <> ".extend (hfinal: hprev: {"
  ]
    ...
    $ braces
      ( [ "description = \"A Haskell " <> projectName <> " workspace generated by HWM(Haskell Workspace Manager)\";",
          ...
          <> letBlock
            ...
            ( forAllSystems "packages" (generatePublicPackages projectName (buildPkgs benv))
